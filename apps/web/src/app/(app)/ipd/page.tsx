...
import { currencySymbol, formatDate, formatDateTime } from '@/lib/format';
...
export default function IpdPage() {
    ...
    if (tab === 'discharged') {
      return {
        ...
        rows: rows.map((a) => [
          ...
          a.consultantName, formatDate(a.admissionDate),
  ...
  const admittedColumns: Column<IpdAdmissionDto>[] = [
    ...
    { key: 'creditLimit', header: `Credit Limit (${currencySymbol()})`, className: 'tabular', render: (a) => a.creditLimit.toFixed(2) },
  ];
  ...
  const dischargedColumns: Column<IpdAdmissionDto>[] = [
    ...
    { key: 'dischargeDate', header: 'Discharged Date', render: (a) => (a.dischargeDate ? formatDateTime(a.dischargeDate) : '—') },
    { key: 'taxAmount', header: `Tax (${currencySymbol()})`, className: 'tabular', render: (a) => a.taxAmount.toFixed(2) },
    { key: 'billedAmount', header: `Net Amount (${currencySymbol()})`, className: 'tabular', render: (a) => a.billedAmount.toFixed(2) },
    { key: 'total', header: `Total (${currencySymbol()})`, className: 'tabular', render: (a) => a.billedAmount.toFixed(2) },
  ];
