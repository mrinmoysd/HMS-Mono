...
/** "Payments" action for a Pathology/Radiology bill: patient/summary + Add Payment + Transaction History. */
export function DiagnosticPaymentsModal({ id, open, onClose }: { id: string | null; open: boolean; onClose: () => void }) {
