...
export function StockView({ onShowItems, onShowIssues }: { onShowItems: () => void; onShowIssues: () => void }) {
  ...
  const cols: Column<ItemStockDto>[] = [
    ...
    { key: 'purchasePrice', sortable: true, header: `Purchase Price (${currencySymbol()})`, className: 'tabular text-right', render: (s) => s.purchasePrice.toFixed(2) },
  ];
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              ...
              <Field label={`Purchase Price (${currencySymbol()})`} required><TextInput type="number" step="0.01" value={form.purchasePrice} onChange={(e) => setForm((f) => ({ ...f, purchasePrice: e.target.value }))} /></Field>
